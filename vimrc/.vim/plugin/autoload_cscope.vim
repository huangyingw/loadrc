...
augroup autoload_cscope
  ...
  au BufEnter *.log     call <SID>Cycle_csdb() | call <SID>Cycle_macros_menus()
  ...
  au BufEnter *.sql     call <SID>Cycle_csdb() | call <SID>Cycle_macros_menus()
  au BufEnter *.vala     call <SID>Cycle_csdb() | call <SID>Cycle_macros_menus()
  ...
  au BufUnload *.log    call <SID>Unload_csdb() | call <SID>Cycle_macros_menus()
  ...
  au BufUnload *.sql     call <SID>Unload_csdb() | call <SID>Cycle_macros_menus()
  au BufUnload *.vala    call <SID>Unload_csdb() | call <SID>Cycle_macros_menus()
