command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete BinaryGrep :execute s:BinaryGrep(<f-args>)
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Copy :execute s:Copy(<f-args>)
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Dodev :execute s:Dodev()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Dps :execute s:Dps()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Fcscope :execute s:Fcscope()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete FindDeleted :execute s:FindDeleted()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Fnotinuse :execute s:Fnotinuse()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Fr :execute s:Fr(<f-args>)
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Fsync :execute s:Fsync()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete G :execute s:G(<q-args>)
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Ga :execute s:Ga(<q-args>)
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gbib :execute s:Gbib()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gbidebug :execute s:Gbidebug()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gbig :execute s:Gbig()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gbil :execute s:Gbil()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gbis :execute s:Gbis()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gbr :execute s:Gbr()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gbra :execute s:Gbra()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gbrd :execute s:Gbrd(<f-args>)
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gbrm :execute s:Gbrm(<f-args>)
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gclean :execute s:Gclean()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gco :execute s:Gco(<f-args>)
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gcob :execute s:Gcob(<f-args>)
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gcof :execute s:Gcof(<f-args>)
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gcom :execute s:Gcom(<q-args>)
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gcp :execute s:Gcp(<f-args>)
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gdev :execute s:Gdev()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gdi :execute s:Gdi(<f-args>)
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gdi2 :execute s:Gdi2(<f-args>)
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gdif :execute s:Gdif(<f-args>)
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gdifo :execute s:Gdifo(<f-args>)
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gdio :execute s:Gdio(<f-args>)
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gfix :execute s:Gfix()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gicb :execute s:Gicb()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gitk :execute s:Gitk(<f-args>)
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Glf :execute s:Glf()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Glg :execute s:Glg()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gme2 :execute s:Gme2(<q-args>)
...
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Grtu :execute s:Grtu()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Grtv :execute s:Grtv()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gs :execute s:Gs()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gsave :execute s:Gsave()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gshow :execute s:Gshow(<q-args>)
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gst :execute s:Gst()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gsti :execute s:Gsti()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gstl :execute s:Gstl()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gstlv :execute s:Gstlv()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gstp :execute s:Gstp(<q-args>)
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gstv :execute s:Gstv(<q-args>)
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gsync :execute s:Gsync()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gtg :execute s:Gtg()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gvd :execute s:Gvd(<f-args>)
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gvdo :execute s:Gvdo()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Gwap :execute s:Gwap()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Jformat :execute s:Jformat()
...
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete SvnRevert :execute s:SvnRevert()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete SvnSt :execute s:SvnSt()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete SvnUp :execute s:SvnUp()
command! -bang -bar -nargs=* -complete=customlist,fugitive#Complete Tail :execute s:Tail()
...
function! s:Gdio(...) abort
    ...
    exec '!~/loadrc/gitrc/gdi.sh ' . '"' .  remote . '/' . branch . '" "' . local_branch . '" 2>&1 | tee ' . '"' .  output . '"'
