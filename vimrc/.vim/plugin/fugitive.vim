command! -bang -bar -nargs=* BinaryGrep :execute s:BinaryGrep(<f-args>)
command! -bang -bar -nargs=* Copy :execute s:Copy(<f-args>)
command! -bang -bar -nargs=* Dodev :execute s:Dodev()
command! -bang -bar -nargs=* Dps :execute s:Dps()
command! -bang -bar -nargs=* Fcscope :execute s:Fcscope()
command! -bang -bar -nargs=* FindDeleted :execute s:FindDeleted()
command! -bang -bar -nargs=* Fnotinuse :execute s:Fnotinuse()
command! -bang -bar -nargs=* Fr :execute s:Fr(<f-args>)
command! -bang -bar -nargs=* Fsync :execute s:Fsync()
command! -bang -bar -nargs=* G :execute s:G(<q-args>)
command! -bang -bar -nargs=* Ga :execute s:Ga(<q-args>)
command! -bang -bar -nargs=* Gbib :execute s:Gbib()
command! -bang -bar -nargs=* Gbidebug :execute s:Gbidebug()
command! -bang -bar -nargs=* Gbig :execute s:Gbig()
command! -bang -bar -nargs=* Gbil :execute s:Gbil()
command! -bang -bar -nargs=* Gbis :execute s:Gbis()
command! -bang -bar -nargs=* Gbr :execute s:Gbr()
command! -bang -bar -nargs=* Gbra :execute s:Gbra()
command! -bang -bar -nargs=* Gbrd :execute s:Gbrd(<f-args>)
command! -bang -bar -nargs=* Gbrm :execute s:Gbrm(<f-args>)
command! -bang -bar -nargs=* Gclean :execute s:Gclean()
command! -bang -bar -nargs=* Gco :execute s:Gco(<f-args>)
command! -bang -bar -nargs=* Gcob :execute s:Gcob(<f-args>)
command! -bang -bar -nargs=* Gcof :execute s:Gcof(<f-args>)
command! -bang -bar -nargs=* Gcom :execute s:Gcom(<q-args>)
command! -bang -bar -nargs=* Gcp :execute s:Gcp(<f-args>)
command! -bang -bar -nargs=* Gdev :execute s:Gdev()
command! -bang -bar -nargs=* Gdi :execute s:Gdi(<f-args>)
command! -bang -bar -nargs=* Gdi2 :execute s:Gdi2(<f-args>)
command! -bang -bar -nargs=* Gdif :execute s:Gdif(<f-args>)
command! -bang -bar -nargs=* Gdifo :execute s:Gdifo(<f-args>)
command! -bang -bar -nargs=* Gdio :execute s:Gdio(<f-args>)
command! -bang -bar -nargs=* Gfix :execute s:Gfix()
command! -bang -bar -nargs=* Gicb :execute s:Gicb()
command! -bang -bar -nargs=* Gitk :execute s:Gitk(<f-args>)
command! -bang -bar -nargs=* Glf :execute s:Glf()
command! -bang -bar -nargs=* Glg :execute s:Glg()
command! -bang -bar -nargs=* Gme2 :execute s:Gme2(<q-args>)
command! -bang -bar -nargs=* Gmet :execute s:Gmet()
command! -bang -bar -nargs=* Gpl :execute s:Gpl()
command! -bang -bar -nargs=* Gps :execute s:Gps()
command! -bang -bar -nargs=* Greview :execute s:Greview()
command! -bang -bar -nargs=* Grsh :execute s:Grsh(<q-args>)
command! -bang -bar -nargs=* Grta :execute s:Grta(<f-args>)
command! -bang -bar -nargs=* Grtu :execute s:Grtu()
command! -bang -bar -nargs=* Grtv :execute s:Grtv()
command! -bang -bar -nargs=* Gs :execute s:Gs()
command! -bang -bar -nargs=* Gsave :execute s:Gsave()
command! -bang -bar -nargs=* Gshow :execute s:Gshow(<q-args>)
command! -bang -bar -nargs=* Gst :execute s:Gst()
command! -bang -bar -nargs=* Gsti :execute s:Gsti()
command! -bang -bar -nargs=* Gstl :execute s:Gstl()
command! -bang -bar -nargs=* Gstlv :execute s:Gstlv()
command! -bang -bar -nargs=* Gstp :execute s:Gstp(<q-args>)
command! -bang -bar -nargs=* Gstv :execute s:Gstv(<q-args>)
command! -bang -bar -nargs=* Gsync :execute s:Gsync()
command! -bang -bar -nargs=* Gtg :execute s:Gtg()
command! -bang -bar -nargs=* Gvd :execute s:Gvd(<f-args>)
command! -bang -bar -nargs=* Gvdo :execute s:Gvdo()
command! -bang -bar -nargs=* Gwap :execute s:Gwap()
command! -bang -bar -nargs=* Jformat :execute s:Jformat()
command! -bang -bar -nargs=* LcTest :execute s:LcTest()
command! -bang -bar -nargs=* LogFilter :execute s:LogFilter(<f-args>)
command! -bang -bar -nargs=* Prune :execute s:Prune()
command! -bang -bar -nargs=* SvnApply :execute s:SvnApply()
command! -bang -bar -nargs=* SvnDiff :execute s:SvnDiff()
command! -bang -bar -nargs=* SvnReset :execute s:SvnReset()
command! -bang -bar -nargs=* SvnRevert :execute s:SvnRevert()
